...
public class ActionBar_1_8_R3 extends ActionBar {
    ...
    public void sendMessage(final Player player, final String message) {
        final PacketPlayOutChat packet = new PacketPlayOutChat(new ChatComponentText(ChatColor.translateAlternateColorCodes('&', Utils.replacePlaceholders(player, false, message))), (byte)2);
